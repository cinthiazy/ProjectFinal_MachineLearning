...
When make the summary in data,  be observe it  the data has many values Missing and NA´s, for this reason be will analysis the attributes.

### **Explorary the data**

* Will be identificate  the attributes with higher percentage the NA´s, and then remove those variables from the data.
